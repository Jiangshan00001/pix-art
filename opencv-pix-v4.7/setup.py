...
def main():
    ...
    build_headless = True#get_build_env_var_by_name("headless")
    ...
    if False:# os.path.exists(".git"):--jiangshan
    ...
    ci_cmake_generator = (
        ["-G", "Visual Studio 15" + (" Win64" if x64 else "")]# 14 is default
        if os.name == "nt"
